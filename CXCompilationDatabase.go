...
func (self CompilationDatabase) Dispose() {
}
...
func (self CompilationDatabase) CompileCommands(CompleteFileName *c.Char) CompileCommands {
	return 0
}
...
func (self CompilationDatabase) AllCompileCommands() CompileCommands {
	return 0
}
...
func (self CompileCommands) Command(I c.Uint) CompileCommand {
	return 0
}
...
func (self CompileCommand) Directory() String {
	return String{}
}
...
func (self CompileCommand) Filename() String {
	return String{}
}
...
func (self CompileCommand) NumArgs() c.Uint {
	return 0
}
...
func (self CompileCommand) Arg(I c.Uint) String {
	return String{}
}
...
func (self CompileCommand) NumMappedSources() c.Uint {
	return 0
}
...
func (self CompileCommand) MappedSourcePath(I c.Uint) String {
	return String{}
}
...
func (self CompileCommand) MappedSourceContent(I c.Uint) String {
	return String{}
}
